...
{
/* 1 */
	readEEPROM(comPort, 230, AccelGainScale);
	readEEPROM(comPort, 130, GyroGainScale);
/* 2 */
	writeEEPROM(comPort, 238, 4);
	usleep(10000);
	writeEEPROM(comPort, 240, 10);
	usleep(10000);
	writeEEPROM(comPort, 242, 250);
	usleep(10000);
	writeEEPROM(comPort, 246, 10);
	usleep(10000);
/* 3 */
