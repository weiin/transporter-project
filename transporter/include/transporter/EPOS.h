  ...
  {    	
	...
	// epos properties
  	...
  	int ActualVelocity;
   	...
   	unsigned int PositionProfileAcceleration;
   	unsigned int PositionProfileDeceleration;
    ...
    */
	...
	void SetMotionProfileType(char profileType);
	...
	void GetPositionProfileAcceleration();
	void SetPositionProfileAcceleration(unsigned int acceleration);
	void GetPositionProfileDeceleration();
	void SetPositionProfileDeceleration(unsigned int deceleration);
	...
	void SetOperationMode(char mode); // ok
